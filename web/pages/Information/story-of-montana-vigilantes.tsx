    ...
    <>
      ...
      <main style={{ display: 'flex', gap: '40px', maxWidth: '1200px', margin: '0 auto', padding: '0 20px', position: 'relative' }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <p>The vigilante movement later spread northward to <Link href="/montana-towns/helena/">Helena</Link> in 1865, where the Committee of Safety continued the practice of extralegal justice. In January 1870, Chinese worker Ah Chow was lynched in <Link href="/montana-towns/helena/">Helena</Link> from what became known as the "Hanging Tree," highlighting the racial prejudice that often infected vigilante actions. And in a final, terrifying echo of the era, the numbers "3-7-77" began appearing painted on doors and tents—a sinister warning to leave town or face the vigilantes' wrath.</p>
        </section>
        <AffiliateBanner />
        <ComingSoon />
        </div>
