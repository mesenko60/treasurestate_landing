...
export default function MiningHistoryOfMontana() {
  return (
    <>
      ...
      <Header />
      <Hero
        title="Mining History of Montana"
        subtitle="From Gold Rush to Ghost Towns"
      ...
      <main style={{ display: 'flex', gap: '40px', maxWidth: '1200px', margin: '0 auto', padding: '0 20px', position: 'relative' }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <p>By the 1870s, the nature of Montana mining had transformed again with the discovery of vast silver deposits, particularly in <Link href="/montana-towns/butte/" style={{ color: '#3b6978' }}>Butte</Link>, which would eventually earn the title "the richest hill on earth." Gold had opened the territory, but copper would dominate its economy for the next century. The <Link href="/montana-towns/anaconda/" style={{ color: '#3b6978' }}>Anaconda</Link> Copper Mining Company, founded by Marcus Daly, would grow to become one of the largest corporations in America and would wield outsized influence in Montana politics and daily life well into the 20th century.</p>
          
          <p>The gold rushes that shaped Montana Territory in its infancy left enduring legacies: towns where none had existed before, transportation networks to service them, territorial status leading rapidly to statehood, and complex multicultural communities thrown together by the universal desire for wealth. They also left a complicated environmental inheritance that Montanans continue to manage, and a boom-and-bust economic pattern that still challenges the state's efforts at sustainable development.</p>
