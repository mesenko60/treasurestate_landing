    ...
    <>
      ...
      <main style={{ display: 'flex', gap: '40px', maxWidth: '1200px', margin: '0 auto', padding: '0 20px', position: 'relative' }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <p>During the last Ice Age, a lobe of the massive Cordilleran ice sheet advanced southward from Canada, creating a natural dam across the Clark Fork River near the present-day town of Sandpoint, Idaho. Behind this ice dam, water began to accumulate, forming a lake that eventually covered much of western Montana, including the areas that are now <Link href="/montana-towns/missoula/" style={{ color: '#3b6978' }}>Missoula</Link>, <Link href="/montana-towns/hamilton/" style={{ color: '#3b6978' }}>Hamilton</Link>, and St. Ignatius. This body of water would have made our present-day <Link href="/planners/corridors/flathead_lake/" style={{ color: '#3b6978' }}>Flathead Lake</Link> look like a farm pond by comparison.</p>
