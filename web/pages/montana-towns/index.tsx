...
export default function TownsIndex({ towns }: { towns: any[] }) {
  return (
    <>
      ...
      <Header />
      <Hero title="Montana Cities and Towns" subtitle="Explore communities across Big Sky Country" image="/images/hero-image.jpg" alt="Montana cities and towns directory" small showSearch />
