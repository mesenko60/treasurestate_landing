...
export function injectStaysCTA(html: string, townName: string, slug: string): { html: string; injected: boolean } {
  ...
  const ctaBlock = `
<div style="display:flex;gap:0.75rem;flex-wrap:wrap;margin:1.25rem 0 0.5rem">
...
<p style="font-size:0.7rem;color:#999;margin:0 0 1rem">Affiliate links help support this site at no extra cost to you.</p>`;
