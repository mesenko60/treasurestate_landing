...
function extractHistoricMarkers() {
  ...
  return data.map(m => ({
    ...
    lat: m.lat,
    lng: m.lng,
    content_url: `/historic-markers/${m.slug}/`,
    nearest_town: m.town,
...
function extractHotSprings() {
  ...
  return data.map(h => ({
    ...
    lat: h.lat,
    lng: h.lng,
    content_url: `/guides/hot-springs-guide/`,
...
function extractCampgrounds() {
  ...
  return data.map(c => ({
    ...
    lat: c.lat,
    lng: c.lng,
    content_url: `/guides/campgrounds-guide/`,
...
function extractHiking() {
  ...
  return data.map(h => ({
    ...
    lat: h.lat,
    lng: h.lng,
    content_url: `/guides/hiking-guide/`,
    nearest_town: h.nearestTownName,
    nearest_town_slug: h.nearestTown,
...
function extractStateParks() {
  ...
  return data.map(p => ({
    ...
    lat: p.lat,
    lng: p.lng,
    content_url: `/guides/state-parks-guide/`,
...
function extractSkiAreas() {
  ...
  return data.map(s => ({
    ...
    lat: s.lat,
    lng: s.lng,
    content_url: `/guides/skiing-guide/`,
...
function extractWildlifeViewing() {
  ...
  return data.map(w => ({
    ...
    lat: w.lat,
    lng: w.lng,
    content_url: `/guides/wildlife-guide/`,
...
function extractPhotographyLocations() {
  ...
  return data.map(p => ({
    ...
    lat: p.lat,
    lng: p.lng,
    content_url: `/guides/photography-guide/`,
    nearest_town: p.nearestTownName,
    nearest_town_slug: p.nearestTown,
    website: p.website,
    address: p.address,
...
function extractHuntingAreas() {
  ...
  return data.map(h => ({
    ...
    lat: h.lat,
    lng: h.lng,
    content_url: `/guides/hunting-guide/`,
    nearest_town: h.nearestTownName,
    nearest_town_slug: h.nearestTown,
    website: h.website,
...
function extractGolfCourses() {
  ...
  return data.courses
    ...
    .map(c => ({
      ...
      lat: c.latitude,
      lng: c.longitude,
      content_url: `/guides/golf-courses-guide/`,
      nearest_town: c.city,
      county: c.county,
      website: c.website,
      phone: c.phone,
