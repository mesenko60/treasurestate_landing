...
(function main() {
  ...
  const planners = [
    ...
    { title: 'Interactive Montana Land Ownership Map (Parcels, Public Lands & GIS)', desc: 'Interactive statewide land ownership map with an onboard steward legend: parcel linework and public lands from Montana GIS, conservation easements, PLSS grid, DNRC/FWP checkpoints, MSDI GIS links.', url: '/guides/land-ownership/', kw: 'Montana land ownership map land map legend steward colors parcel GIS public lands map property boundaries PLSS Treasure State GIS conservation easements Montana Cadastral' },
