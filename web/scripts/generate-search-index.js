...
(function main() {
  ...
  const planners = [
    ...
    { title: 'Interactive Montana Land Ownership Map (Parcels, Public Lands & GIS)', desc: 'Guide and disclaimers for Montana State Library GIS layers; open the full-screen map from this page.', url: '/guides/land-ownership/', kw: 'Montana land ownership map land map legend steward colors parcel GIS public lands map property boundaries PLSS Treasure State GIS conservation easements Montana Cadastral' },
    { title: 'Montana Land Map — Full Viewport GIS', desc: 'Full-screen Montana map: Topo, Satellite, Hybrid with DEM shaded relief, optional 3D terrain, MSDI parcels and public lands, PLSS grid, hunting pins.', url: '/map/', kw: 'Montana map full screen GIS Topo satellite Hybrid shaded relief 3D terrain MSDI parcels public lands PLSS hunting pins Mapbox steward legend' },
