...
(function main() {
  ...
  const planners = [
    ...
    { title: 'Montana Land Map — Full Viewport GIS', desc: 'Full-screen Montana map: Topo and satellite basemaps, optional 3D terrain, MSDI parcels and public lands, PLSS grid, hunting pins.', url: '/map/', kw: 'Montana map full screen GIS Topo satellite 3D terrain MSDI parcels public lands PLSS hunting pins Mapbox steward legend' },
