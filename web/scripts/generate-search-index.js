...
(function main() {
  ...
  const planners = [
    ...
    { title: 'Montana Land Ownership Map & GIS Guide', desc: 'MSDI cadastral map for public lands, conservation easements, parcels, PLSS grid, DNRC hunter context, statewide FTP GIS downloads', url: '/guides/land-ownership/', kw: 'Montana cadastral land ownership parcels PLSS DNRC GIS public lands conservation easement hunter access Treasure State MSDI cadastral' },
