  ...
  return (
    <footer>
      <nav aria-label="Footer navigation" style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '0.5rem 1.5rem', marginBottom: '1.25rem', fontSize: '0.85rem' }}>
        ...
        <Link href="/planners/summer-road-trips/" style={{ color: '#ddd', textDecoration: 'none' }}>Summer Road Trips</Link>
        <Link href="/planners/winter-driving-guide/" style={{ color: '#ddd', textDecoration: 'none' }}>Winter Driving Guide</Link>
