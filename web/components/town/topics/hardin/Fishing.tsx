  ...
  return (
    <article className="content-section">
      <p>
        ...
        to the east,         and multiple FWP fishing access sites along the <Link href="/guides/fly-fishing-rivers#yellowstone-river" style={{ color: '#3b6978', textDecoration: 'none' }}>Yellowstone River</Link> corridor,
        and {townName} offers a fishing base that punches far above its weight. For Montana's fly fishing heritage, see our <Link href="/guides/fly-fishing-guide" style={{ color: '#3b6978', textDecoration: 'none' }}>Fly Fishing Guide</Link>. For the full town
