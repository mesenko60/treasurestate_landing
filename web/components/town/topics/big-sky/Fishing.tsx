  ...
  return (
    <article className="content-section">
      <p>
        ...
        The <Link href="/guides/fly-fishing-rivers#gallatin-river" style={{ color: '#3b6978', textDecoration: 'none' }}>Gallatin River</Link>{'\u2014'}immortalized in Norman Maclean's <em>A River Runs Through It</em> and
        ...
        For Montana's fly fishing heritage, see our <Link href="/guides/fly-fishing-guide" style={{ color: '#3b6978', textDecoration: 'none' }}>Fly Fishing Guide</Link>. For the full community profile, see
