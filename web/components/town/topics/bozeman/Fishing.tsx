  ...
  return (
    <article className="content-section">
      <p>
        ...
        The <Link href="/guides/fly-fishing-rivers#gallatin-river" style={{ color: '#3b6978', textDecoration: 'none' }}>Gallatin</Link>, <Link href="/guides/fly-fishing-rivers#madison-river" style={{ color: '#3b6978', textDecoration: 'none' }}>Madison</Link>, and <Link href="/guides/fly-fishing-rivers#yellowstone-river" style={{ color: '#3b6978', textDecoration: 'none' }}>Yellowstone</Link> rivers — three of the most celebrated trout
        ...
        fishing portfolio that rivals any mountain town in the West. For Montana's fly fishing heritage, see our <Link href="/guides/fly-fishing-guide" style={{ color: '#3b6978', textDecoration: 'none' }}>Fly Fishing Guide</Link>. For the full city profile,
