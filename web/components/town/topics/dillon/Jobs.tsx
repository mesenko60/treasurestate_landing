  ...
  return (
    <article className="content-section">
      <p>
        ...
        Beaverhead River winds north toward its confluence with the <Link href="/guides/fly-fishing-rivers#big-hole-river" style={{ color: '#3b6978', textDecoration: 'none' }}>Big Hole</Link>. The economy blends
        higher education, healthcare, agriculture, mining, and a growing tourism sector built
        around world-class <Link href="/guides/fly-fishing-guide" style={{ color: '#3b6978', textDecoration: 'none' }}>fly fishing</Link>, hot springs, and proximity to Bannack State Park. With
