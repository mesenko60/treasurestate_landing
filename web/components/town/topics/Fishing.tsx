  ...
  return (
    <article className="content-section">
      <p>
        ...
        the Blackfoot, and the <Link href="/guides/fly-fishing-rivers#bitterroot-river" style={{ color: '#3b6978', textDecoration: 'none' }}>Bitterroot</Link>{' '}—{' '}making it one of the premier fly fishing
        ...
        year-round angling opportunities for every skill level. For Montana's fly fishing heritage and the Skwala hatch, see our <Link href="/guides/fly-fishing-guide" style={{ color: '#3b6978', textDecoration: 'none' }}>Fly Fishing Guide</Link>. For the full city profile,
