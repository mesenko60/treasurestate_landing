...
export default function Fishing({ townName, slug, fishingAccess, rivers, lakes }: Props) {
  ...
  return (
    <article className="content-section">
      <p>
        {townName} sits on the <Link href="/guides/fly-fishing-rivers#bitterroot-river" style={{ color: '#3b6978', textDecoration: 'none' }}>Bitterroot River</Link>{'\u2014'}one of Montana{'\u2019'}s most celebrated trout
        ...
        Montana. For Montana's fly fishing heritage and the Skwala hatch, see our <Link href="/guides/fly-fishing-guide" style={{ color: '#3b6978', textDecoration: 'none' }}>Fly Fishing Guide</Link>. For the full city profile, see
