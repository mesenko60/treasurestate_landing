  ...
  return (
    <article className="content-section">
      <p>
        ...
        The <Link href="/guides/fly-fishing-rivers#yellowstone-river" style={{ color: '#3b6978', textDecoration: 'none' }}>Yellowstone River</Link>, Montana's longest undammed river, flows directly through the
        ...
        downtown, and {townName} offers fishing diversity that few Montana cities can match. For Montana's fly fishing heritage and river guides, see our <Link href="/guides/fly-fishing-guide" style={{ color: '#3b6978', textDecoration: 'none' }}>Fly Fishing Guide</Link>. For
