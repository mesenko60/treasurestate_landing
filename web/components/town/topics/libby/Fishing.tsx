  ...
  return (
    <article className="content-section">
      <p>
        ...
        are native and protected{'\u2014'}catch-and-release regulations apply. For Montana's fly fishing heritage, see our <Link href="/guides/fly-fishing-guide" style={{ color: '#3b6978', textDecoration: 'none' }}>Fly Fishing Guide</Link>. For the full town profile, see
