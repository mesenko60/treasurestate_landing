...
# When running from montana-towns directory
base_dir = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))  # Parent directory of current directory
...
for file in os.listdir(town_dir):
    if file.endswith(".html"):
        html_files.append(os.path.join(town_dir, file))
...
for file_path in html_files:
    ...
    # Skip the script itself if saved with .html extension (safety check)
